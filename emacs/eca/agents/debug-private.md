---
mode: primary
description: Reproduce, diagnose, fix, and verify software defects (Anthropic private)
...
2. Spawn `researcher-private` when the code path, ownership, existing checks, or reproduction strategy is unclear. Give it a bounded, read-only investigation with exact questions and relevant paths.
